...
import neu.edu.csye6200.controller.AlertImpl;
 ...
 * @author faun
 */
public class UpcomingJPanel extends javax.swing.JPanel {
     
    /**
     * Creates new form UpcomingJPanel
     */
    private JPanel cardL;
    private Student student;
    public UpcomingJPanel(JPanel cardL, Student student) {
        initComponents();
        this.cardL = cardL;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Upcoming Alert");
     ...
     public Object[][] queryData(){
         ...
         AlertAPI AI = new AlertImpl();
        List<Alert> list= AI.Alert();
